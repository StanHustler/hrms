...
<div class="x-nav">
    ...
    <a class="layui-btn layui-btn-small" style="line-height:1.6em;float:right;background-color: transparent;" href="${ctx }/finance/list?pageNum=${pageInfo.pageNum}&pageSize=6" title="刷新">
