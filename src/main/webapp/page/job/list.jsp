...
<html>
  ...
  <body>
    <div class="x-nav">
      ...
      <a class="layui-btn layui-btn-small" style="line-height:1.6em;float:right;background-color: transparent;" href="${ctx }/job/list?pageNum=${pageInfo.pageNum}&pageSize=6" title="刷新">
      ...
      <div class="layui-row" style="" align="center">
        <form class="layui-form layui-col-md12 x-so" method="get" action="${ctx }/job/list">
          ...
          <input type="hidden" name="pageSize" value="6"/>
            <div class="insearch" >
                <input type="text" name="content" style="width:90%; float: left;border: none;"  placeholder="请输入查找内容" autocomplete="off" class="layui-input"/>
